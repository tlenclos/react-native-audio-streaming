...
- (void)registerRemoteControlEvents
{
    ...
    // [commandCenter.seekBackwardCommand addTarget:self action:@selector(didReceivePlayCommand:)];
    // commandCenter.seekForwardCommand.enabled = YES;
    // [commandCenter.seekForwardCommand addTarget:self action:@selector(didReceivePauseCommand:)];
